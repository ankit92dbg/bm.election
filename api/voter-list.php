...
$page_query = "";
 if(isset($_POST['action']) && $_POST['action']=='searchTab'){
    ...
    echo $query = "SELECT voters_data.PART_NO,voters_data.LASTNAME_EN,voters_data.LASTNAME_V1, COUNT(*) AS Total FROM `voters_data` WHERE $WHERE GROUP BY voters_data.LASTNAME_EN LIMIT $start_from, $record_per_page";
